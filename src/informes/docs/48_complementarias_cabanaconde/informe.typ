...
//generales
#let numero_documento = 48
#let date_day = 28
#let date_month = 5
#let date_year = 2025
#let asunto = "METAS, ACTIVIDADES Y UBICACIÓN DE LAS ACTIVIDADES COMPLEMENTARIAS PARA EL MANTENIMIENTO VIAL RUTINARIO DEL CAMINO VECINAL EMP. R0405104 (CABANACONDE) A PTE. CABANACONDE - CHOCO - L.P CASTILLA (KM 13+000) - ACTIVIDAD COMPLEMENTARIA REPARACIÓN DE BADENES"
...
///////////////////////////////////////
///////////////////////////////////////
Mediante la presente me dirijo a usted para saludarlo y a la vez derivarle el Documento Técnico de la Actividad Complementaria para el Camino Vecinal EMP. R0405104 (CABANACONDE) A PTE. CABANACONDE - CHOCO - L.P CASTILLA (KM 13+000), Distrito de Cabanaconde, al respecto informe lo siguiente:
...
En ese contexto, el presente informe se elabora en el marco del expediente técnico denominado “Mantenimiento Vial Rutinario del Camino Vecinal EMP. R0405104 (Cabanaconde) a Pte. Cabanaconde - Choco - L.P. Castilla (KM 13+000) - Actividad Complementaria Reparación de Badenes”, cuyo objetivo es ejecutar la reparación del Baden en la progresiva 5+740, que son estructuras fundamentales para el adecuado drenaje superficial y la protección de la plataforma vial.
...
La carretera EMP. R0405104 (CABANACONDE) A PTE. CABANACONDE - CHOCO - L.P CASTILLA (KM 13+000) es una vía afirmada de acceso rural que conecta varias comunidades locales. Tiene un tráfico moderado, compuesto principalmente por vehículos ligeros y agrícolas. Sin embargo, el desgaste debido a factores climáticos y la falta de señalización en tramos con curvas y pendientes ha incrementado el riesgo de accidentes y daños estructurales en la vía.

- Longitud total del tramo: 13.000 km
- Ancho de calzada: 4.50 - 5.00 metros


== Evaluación del estado actual

=== Reparación del badén en el kilómetro 5+740

El badén ubicado en el kilómetro 5+740 presenta un deterioro severo debido a la acumulación de agua y la erosión en su estructura. Esto afecta tanto la funcionalidad del drenaje como la seguridad de los vehículos que transitan por la zona, exponiéndolos a daños mecánicos y deslizamientos.
...
BADEN
- Progresiva: 5+740
- Área del Baden: 59.85 m2
- Área deteriorada: 59.85 m2
- Estado: Deteriorado al 100%
- Área a reparar: 59.85 m2

#figure(
  image("./images/baden.png", width: 100%),
  caption: "Reparación del badén en el kilómetro 5+740",
)

== Presupuesto y cronograma de ejecución

Para la ejecución MANTENIMIENTO VIAL RUTINARIO DEL CAMINO VECINAL EMP. R0405104 (CABANACONDE) A PTE. CABANACONDE - CHOCO - L.P CASTILLA (KM 13+000) - ACTIVIDAD COMPLEMENTARIA REPARACIÓN DE BADENES. El presupuesto y las actividades a realizar se resumen en lo siguiente:
...
El Presupuesto Total es de S/. 16,145.10 SOLES, con un plazo de ejecución de 15 días calendarios.
...
Las actividades de creación de dispositivos de seguridad vial (postes delineadores) y la reparación del badén en el kilómetro 5+740 son esenciales para mejorar la seguridad y transitabilidad de la carretera afirmada R0405106. Se recomienda proceder con la ejecución inmediata de los trabajos para evitar mayores deterioros de la vía y reducir el riesgo de accidentes en los tramos identificados.

Así mismo en el documento técnico Capitulo 4 Panel Fotográfico se sustenta con evidencia fotográfica la necesidad de la ejecución de esta actividad SECCIÓN 637 REPARACIÓN DE BADENES.
