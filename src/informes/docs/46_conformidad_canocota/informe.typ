...
#let asunto = (
  "Conformidad del servicio"
    + ": "
    + "MANTENIMIENTO VIAL RUTINARIO CAMINO VECINAL EMP. AR-683 - CANOCOTA (DV. TUTI), DISTRITO DE CHIVAY, PROVINCIA DE CAYLLOMA, DEPARTAMENTO DE AREQUIPA"
)

#let referencia = (
  "Informe N.º 005-2025-IVP-CAYLLOMA-INS",
)
