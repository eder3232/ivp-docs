...
#let asunto = (
  "Conformidad del servicio"
    + ": "
    + "MANTENIMIENTO VIAL RUTINARIO CAMINO VECINAL EMP. AR-111 (NUEVO SIBAYO) - TUTI - EMP.AR-681 (DV. CHIVAY), DISTRITOS DE CHIVAY, TUTI Y SIBAYO, PROVINCIA DE CAYLLOMA, DEPARTAMENTO DE AREQUIPA"
)

#let referencia = (
  "Informe N.º 006-2025-IVP-CAYLLOMA-INS",
)
...
#figure(image("./images/valorizacion_v2.png", width: 100%))
